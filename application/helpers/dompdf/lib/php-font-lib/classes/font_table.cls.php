...
class Font_Table extends Font_Binary_Stream {
  ...
  protected $V4o5wb5ucdu5;
  protected $Vrylphpo42p4 = array();
  
  public $Vou4vxorrdoe;
  
  final public function __construct(Font_Table_Directory_Entry $V4o5wb5ucdu5) {
    $this->entry = $V4o5wb5ucdu5;
    $V4o5wb5ucdu5->setTable($this);
  }
  ...
  final public function encode(){
    ...
    if (false && empty($this->def)) {
      $Volq3gdvkuqp = $this->_encodeRaw();
    }
    else {
      $Volq3gdvkuqp = $this->_encode();
    }
