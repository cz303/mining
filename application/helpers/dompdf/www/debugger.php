<?php 
$Vuvdyzan5vxw = glob("test/*.{html,htm,php}", GLOB_BRACE);
?>
  ...
  <tr>
    <td colspan="3">
      ...
      <select onchange="$('#addressbar').val($(this).val()); updateAddress()" id="examples">
        <?php foreach($Vuvdyzan5vxw as $Vg5mhfl1beoi) { ?>
          <option value="<?php echo basename($Vg5mhfl1beoi); ?>"><?php echo basename($Vg5mhfl1beoi); ?></option>
        <?php } ?>
      </select>
