    ...
    <section class="col-sm-9">                                       
        <header class="hidden-print">
            <div class="row ">
                <div class="col-sm-12">
                    <?php if ($role != '2') { ?>
						<a href="<?= base_url('admin/tickets/index/edit_tickets') ?>/<?= $tickets_info->tickets_id ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                    <?php if ($role == '1') { ?>
                        <a href="<?= base_url('admin/tickets/delete/delete_tickets') ?>/<?= $tickets_info->tickets_id ?>" onclick="return confirm('Are you sure you want to delete this ticket ?');" class="btn btn-sm btn-danger" data-toggle="ajaxModal"><i class="fa fa-trash-o"></i></a>
                    <?php } ?>
            ...
            <div  class="col-lg-7">
                ...
                <section class="media-body">
                    ...
                    <section class="panel panel-default">
                        <form method="post" action="<?= base_url() ?>admin/tickets/index/save_reply/<?= $tickets_info->tickets_id ?>">

                            <textarea class="form-control no-border" name="body" rows="3" placeholder="Ticket #<?= $tickets_info->ticket_code ?> reply"></textarea>
                ...
                <?php
                $ticket_replies = $this->db->where(array('tickets_id' => $tickets_info->tickets_id))->order_by('tickets_replies_id','desc')->get('tbl_tickets_replies')->result();
