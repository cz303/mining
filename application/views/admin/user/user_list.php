        ...
        <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="col-md-5">
						<select class="search_by form-control" name="search_by">
							<option value="">Search By</option>
							<option  value="fullname" <?php if($search_by== 'fullname') echo 'selected';?>>Name</option>
							<option value="email" <?php if($search_by== 'email') echo 'selected';?>>Email</option>
							<option value="username" <?php if($search_by== 'username') echo 'selected';?>>Username</option>
							<option value="status" <?php if($search_by== 'status') echo 'selected';?> >Status</option>
						</select>
					</div>
					<div class="col-md-5">
						<input type="text" class="search_value form-control" name="search_value" value="<?php echo $search_value;?>" placeholder="Search value">
						<select class="user_status form-control display_none" name="user_status">
							<option value="active" <?php if($user_status== 'active') echo 'selected';?>>Active</option>
							<option value="deactivated" <?php if($user_status== 'deactivated') echo 'selected';?>>Deactivated</option>
							<option value="banned" <?php if($user_status== 'banned') echo 'selected';?>>Banned</option>
						</select>
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<button type="button" class="btn btn-warning reset_btn">Reset</button>
					</div>
				</div>
			</div>
			</form>	
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($v_user->user_id != 1): ?>
                                            ...
                                            <?php else: ?>                                              
												...
												<a href="<?php echo base_url() ?>admin/user/change_banned/<?php echo $v_user->user_id; ?>" class="btn btn-danger btn-xs" title="Click to <?= lang('banned') ?>" data-toggle="modal" data-placement="top" data-target="#myModal"><span class="fa fa-close"></span></a>
                                            <?php endif; ?>                       
											...
											<a data-toggle="tooltip" data-placement="top" class="btn btn-success btn-xs" title="Click to view transaction"  href="<?php echo base_url() ?>admin/user/transactions/<?php echo $v_user->user_id; ?>"><span class="fa fa-money"></span></a>
                                        <?php endif; ?>
                                    </td>
...
$('body').on('change','.search_by',function(){
	
	if($(this).val()== 'status'){
		$('.user_status').removeClass('display_none');
		$('.search_value').addClass('display_none');
	}else{
		$('.user_status').addClass('display_none');
		$('.search_value').removeClass('display_none');
	}
	$('.search_value').val('');
