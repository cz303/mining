            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">                    
                    ...
                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('site_name') ?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('logo') ?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('company_logo') ?></label>
                        <div class="col-lg-7" >                                                        
                    ...
                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('sidebar_theme') ?></label>
                        <div class="col-lg-4">
                ...
                <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('country_in_reg') ?></label>
                        <div class="col-lg-4">
                            <?php $country_in_reg = config_item('country_in_reg'); 
                                $checked='';
                                if($country_in_reg==1){
                                    $checked='checked';
                                }
                            ?>                                
                                <input name="country_in_reg" id="country_in_reg" value="<?php echo $country_in_reg;?>" <?php echo $checked?> class="" type="checkbox">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('captcha_in_reg') ?></label>
                        <div class="col-lg-4">
                            <?php $captcha_in_reg = config_item('captcha_in_reg'); 
                                $checked='';
                                if($captcha_in_reg==1){
                                    $checked='checked';
                                }
                            ?>                                
                                <input name="captcha_in_reg" id="captcha_in_reg" value="<?php echo $captcha_in_reg;?>" <?php echo $checked?> class="" type="checkbox">
                        </div>
                    </div>                  

                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('captcha_in_login') ?></label>
                        <div class="col-lg-4">
                            <?php $captcha_in_login = config_item('captcha_in_login'); 
                                $checked='';
                                if($captcha_in_login==1){
                                    $checked='checked';
                                }
                            ?>                                
                                <input name="captcha_in_login" id="captcha_in_login" value="<?php echo $captcha_in_login;?>" <?php echo $checked?> class="" type="checkbox">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-5 control-label"><?= lang('captcha_in_contact') ?></label>
                        <div class="col-lg-4">
                            <?php $captcha_in_contact = config_item('captcha_in_contact'); 
                                $checked='';
                                if($captcha_in_contact==1){
                                    $checked='checked';
                                }
                            ?>                                
                                <input name="captcha_in_contact" id="captcha_in_contact" value="<?php echo $captcha_in_contact;?>" <?php echo $checked?> class="" type="checkbox">
                        </div>
                    </div>
                <div class="form-group">
