...
<div class="btn-group pull-right add-new-page">
	<a class="btn" href="<?php echo site_url('admin/pages/form'); ?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_page');?></a>
	<?php /*?><a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/pages/link_form'); ?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_link');?></a><?php */?>
</div>
<div class="nav-tabs-custom pages-custom">
