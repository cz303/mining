            ...
            <div  class="col-lg-7">
                ...
                <section class="media-body">
                    ...
                    <section class="panel panel-default">
                        <form method="post" action="<?= base_url() ?>client/tickets/index/save_reply/<?= $tickets_info->tickets_id ?>">
                            <textarea class="form-control no-border" required name="body" rows="3" placeholder="Ticket #<?= $tickets_info->ticket_code ?> reply"></textarea>
                ...
                <?php
                $ticket_replies = $this->db->where(array('tickets_id' => $tickets_info->tickets_id))
				->order_by('tickets_replies_id','desc')
				->get('tbl_tickets_replies')->result();
