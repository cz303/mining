...
<html>
    <head>
        ...
        <link href="<?php echo base_url(); ?>asset/css/icomoon.css" rel="stylesheet"  type="text/css">
        <link href="<?php echo base_url(); ?>asset/css/toastr.min.css" rel="stylesheet"  type="text/css">
