...
abstract class PHPExcel_Writer_PDF_Core extends PHPExcel_Writer_HTML
{
    ...
    protected $Vgmfser0k5hy = '';

    
    protected $Vjilv0hwv0xf = 'freesans';

    
    protected $Vqfc3f2mhizv    = NULL;

    
    protected $Vmqhdgsbwlmh    = NULL;


    
	private $Vqypmvxiytf2;

    
    protected static $Vmqhdgsbwlmhs = array(
    ...
    public function setFont($Vgadaz1roxho)
    {
        $this->_font = $Vgadaz1roxho;
        return $this;
    }
    ...
    {
        if (is_dir($Vqujkwol1zut)) {
            $this->_tempDir = $Vqujkwol1zut;
        } else {
            throw new PHPExcel_Writer_Exception("Directory does not exist: $Vqujkwol1zut");
        }
        return $this;
    }

    
    protected function prepareForSave($V1tltbb5c5oc = NULL)
    {
        ...
        $Vsg4lebcui4l = fopen($V1tltbb5c5oc, 'w');
    ...
    protected function restoreStateAfterSave($Vsg4lebcui4l)
    {
