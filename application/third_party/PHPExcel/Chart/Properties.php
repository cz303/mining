...
abstract class PHPExcel_Properties {
  ...
  protected function  getExcelPointsWidth($Vojs2qdgagwv) {
    return $Vojs2qdgagwv * 12700;
  }

  protected function getExcelPointsAngle($Vdbkfmikyl2i) {
    return $Vdbkfmikyl2i * 60000;
  }

  protected function getTrueAlpha($Vooexq0bqp2f) {
    return (string) 100 - $Vooexq0bqp2f . '000';
  }

  protected function setColorProperties($Vl5jzlxo3j3n, $Vooexq0bqp2f, $V4pigtpor0ln) {
    return array(
        'type' => (string) $V4pigtpor0ln,
        'value' => (string) $Vl5jzlxo3j3n,
        'alpha' => (string) $this->getTrueAlpha($Vooexq0bqp2f)
    );
  }

  protected function getLineStyleArrowSize($Vc3skopr1ojh, $V20ydabxqosi) {
    $Voa40yygjgfq = array(
        1 => array('w' => 'sm', 'len' => 'sm'),
    ...
    return $Voa40yygjgfq[$Vc3skopr1ojh][$V20ydabxqosi];
  }

  protected function getShadowPresetsMap($V33gvubsq010) {
    $Vtr5eyqkeqdw = array(
    ...
    return $Vtr5eyqkeqdw[$V33gvubsq010];
  }

  protected function getArrayElementsValue($Vdzateo11wzq, $Vqy5grnvvrgx) {
    $V55wydy2lnue = & $Vdzateo11wzq;
    if (!is_array($Vqy5grnvvrgx)) {
      return $V55wydy2lnue[$Vqy5grnvvrgx];
    } else {
      foreach ($Vqy5grnvvrgx as $Vqvryofqinbe) {
        $V55wydy2lnue = & $V55wydy2lnue[$Vqvryofqinbe];
      }
